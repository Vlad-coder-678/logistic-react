...
const AppealSection = () => {
  ...
  return (
    <Box variant="div" id="contacts" className={classes.appeal__section}>
      <Container fixed>
        ...
        <Box variant="div" className={classes.appeal__content}>
          <Box variant="div" className={classes.appeal__contentContacts}>
            ...
            <Box variant="div" className={classes.appeal__contactsPhoneWrapper}>
              <Link href="viber://chat?number=+79788540106">
                <svg
                  className={classes.appeal__contactsViberIcon}
                  width="26"
                  height="26"
              ...
              <Link href="whatsapp://send?phone=79788540106">
                <WhatsAppIcon
                  fontSize={"small"}
                  className={classes.colorSecondary}
                />
...
// Для Telegram <a href="tg://resolve?domain=имя"></a>
